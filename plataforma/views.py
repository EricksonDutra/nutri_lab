...
def pacientes(request):
    if request.method == "GET":
        ...
        return render(request, 'plataforma/paciente.html', {'pacientes': pacientes})
...
def dados_paciente_listar(request):
    if request.method == "GET":
        pacientes = Pacientes.objects.filter(nutri=request.user)
        return render(request, 'plataforma/dados_paciente_listar.html', {'pacientes': pacientes})
...
def dados_paciente(request, id):
    ...
    if request.method == "GET":
        ...
        return render(request, 'plataforma/dados_paciente.html', {'paciente': paciente, 'dados_paciente': dados_paciente})
    elif request.method == "POST":
...
def plano_alimentar_listar(request):
    if request.method == "GET":
        pacientes = Pacientes.objects.filter(nutri=request.user)
        return render(request, "plataforma/plano_alimentar_listar.html", {'pacientes': pacientes})
...
def plano_alimentar(request, id):
    ...
    if request.method == "GET":
        ...
        return render(request, 'plataforma/plano_alimentar.html', {'paciente': paciente, 'refeicao':r1, 'opcao': opcao})
